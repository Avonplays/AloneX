...
from AloneX.plugins.playlist import del_plist_msg
from AloneX.plugins.sudoers import sudoers_list
from AloneX.utils.database import (add_served_chat,
                                       add_served_user,
                                       get_served_chats,
                                       get_served_users,
                                       blacklisted_chats,
...
from AloneX.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
...
@app.on_message(
    filters.command(get_command("lodabc"))
    & filters.private
    & ~filters.edited
    & ~BANNED_USERS
)
...
● 🎸 **𝐍αмє ➪ [{title}]({link})**　　
★ 　° :. ★　 ♫ • ○ ° ★ ☆ . * ● ¸ .✦ .✮
● 💽 **𝐃υяαтισи ➪ [{duration} ᴍɪɴ.]({link})**☆¸¸♡¸¸★
★ 　° :. ★　 ♫ • ○ ° ★ ☆ . * ● ¸ .✦ .❊
● 🕹 **𝐕ιєωѕ ➪ [{views}]({link})**.♫.☆ ¸¸♡¸¸ ✭
•✰˚♫. * ● ¸ .★ .¸¸♡¸¸★ :●. ♫°☆ ¸. ● .. ✫
● ⏰ **𝐔ρℓσα∂є∂ 𝐎и ➪ [{published}]({link})**. ✰
° °☆ 　¸. ● . .¸¸♡¸¸.★　★✰˚♫. ○  ✦ .✵
● 📺 **𝐂нαииєℓ ➪ [{channel}]({link})**★
•✰˚♫. * ● ¸ . ★ .¸¸♡¸¸★ :●. *°☆ ¸. ● .. ✧
● 🗯 **𝐂нαииєℓ 𝐋ιик ➪ [ᴠɪsɪᴛ ᴄʜᴀɴɴᴇʟ]({channellink})**✰
•✰˚♫. * ● ¸ . ★ .¸¸♡¸¸★ :●. *°☆ ¸. ● .. ★
